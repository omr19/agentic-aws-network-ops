...
The placeholder resource IDs are expected to be supplied only by a separately approved deployment design. This fixture does not authorize the existing diagnostic or Runtime identities. Phase 8 is complete only under the bounded-validation scope recorded in the project checklist and status; this fixture does not claim live production remediation.
