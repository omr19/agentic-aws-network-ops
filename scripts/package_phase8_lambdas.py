...
PACKAGE_SPECS = (
    PackageSpec(
        ...
        entrypoint="agentic_aws_network_ops.approval.lambda_interface:handle_approval_event",
    ...
    PackageSpec(
        ...
        entrypoint="agentic_aws_network_ops.remediation.lambda_interface:handle_remediation_event",
